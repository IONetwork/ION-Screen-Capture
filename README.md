...
<p align="center">
  <img src="ui/ui_rigol.png" alt="ION Screen Capture - Rigol" width="49%" />
  <img src="ui/ui_keysight.png" alt="ION Screen Capture - Keysight" width="49%" />
</p>
...
Builds are unsigned, so Windows SmartScreen may show a one-time "unknown publisher" prompt - choose _More info → Run anyway_.
